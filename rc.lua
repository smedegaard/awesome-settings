...
beautiful.init("/usr/share/awesome/themes/anders/theme.lua")
...
tags = {
  names  = { "main", "www", "com", "music", "misc", 6, 7, 8, 9 },
  layout = { layouts[8], layouts[1], layouts[2], layouts[5], layouts[6],
  layouts[1], layouts[9], layouts[3], layouts[7]
}}
for s = 1, screen.count() do
